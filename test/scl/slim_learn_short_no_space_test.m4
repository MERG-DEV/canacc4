...
begin
  ...
  slim_learn_short_no_space_test: process is
    ...
    begin
      ...
      report("slim_learn_short_no_space_test: Green LED (SLiM) on");
      --
      ...
      --
      report("slim_learn_short_no_space_test: Short On 0x0102, 0x0180");
      ...
      report("slim_learn_short_no_space_test: Short On 0x0102, 0x0181");
      RXB0D0 <= 16#98#;    -- ACON, CBUS accessory short on
      RXB0D1 <= 1;         -- NN high
      RXB0D2 <= 2;         -- NN low
      RXB0D3 <= 2;
      ...
      PIR3.RXB0IF <= '1';
      --
      report("slim_learn_short_no_space_test: Awaiting CMDERR");
