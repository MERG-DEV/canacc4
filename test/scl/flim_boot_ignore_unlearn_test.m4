...
define(test_name, flim_boot_ignore_unlearn_test)dnl
...
begin
  ...
  test_name: process is
    ...
    begin
      ...
      --
      tx_wait_for_node_response(16#74#, 4, 2, 5, number of stored events) -- EVLNF, CBUS available event space response node 4 2
      --
